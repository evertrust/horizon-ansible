...
description: Performs a recovery against the Horizon API.
notes:
...
options:
  certificate_pem:
    description: The PEM encoded certificate to recover.
    required: true
    type: raw
    suboptions:
      src:
        description: The path to the PEM encoded certificate to recover.
        required: false
        type: path
  password:
    description:
...
certificate:
  ...
  returned: On successful certificate recovery
  type: dict
  contains:
    metadata:
